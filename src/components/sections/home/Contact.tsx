...
const DEFAULT_CONTACT = {
  badge: 'Get in Touch',
  mainTitle: 'Connect with Our',
  mainTitleHighlight: 'Master Artisans',
  mainDescription:
    'Have questions about our handcrafted jewelry or need assistance with custom pieces? Our artisan team is here to help bring your vision to life.',
  formTitle: 'Commission Inquiry',
  formDescription:
    "Tell us about your dream piece and we'll craft something uniquely yours within 2-3 weeks.",
  submitButton: 'Send Inquiry',
  contactSectionTitle: 'Reach Our Atelier',
  method1Title: 'Email Consultation',
  method1Description: 'Detailed jewelry inquiries',
  method1Contact: 'artisans@handmadejewelry.com',
  method2Title: 'Personal Consultation',
  method2Description: 'Speak with master jewelers',
  method2Contact: '+1 (555) 847-2639',
  method3Title: 'Live Design Chat',
  method3Description: 'Real-time design assistance',
  method3Contact: 'Available 9 AM - 7 PM EST',
  officesSectionTitle: 'Artisan Studios',
  office1City: 'Manhattan Atelier',
  office1Address: '127 Greene Street, SoHo District',
  office1Timezone: 'EST (UTC-5)',
  office2City: 'Beverly Hills Studio',
  office2Address: '9640 Santa Monica Blvd, Suite 200',
  office2Timezone: 'PST (UTC-8)',
  office3City: 'London Workshop',
  ...
  hoursSaturdayTime: '11:00 AM - 5:00 PM',
  hoursSundayLabel: 'Sunday',
  hoursSundayTime: 'By Appointment Only',
  supportNote: 'Priority consultation available for custom orders over $2,000',
  nameLabel: 'Full Name *',
  namePlaceholder: 'Sarah Johnson',
  emailLabel: 'Email Address *',
  emailPlaceholder: 'sarah@email.com',
  companyLabel: 'Occasion (Optional)',
  companyPlaceholder: 'Anniversary, Engagement, Gift...',
  messageLabel: 'Design Vision *',
  messagePlaceholder:
    'Describe your ideal piece - style preferences, gemstones, metals, inspiration, or any special requirements...',
} as const;
