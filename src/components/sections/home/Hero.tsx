...
const DEFAULT_HERO = {
  badge: 'New: Limited Edition Collection',
  title: 'Discover timeless elegance with',
  titleHighlight: 'handcrafted jewelry',
  description:
    'Each piece is meticulously crafted by skilled artisans using premium materials. From delicate rings to statement necklaces, find jewelry that tells your unique story.',
  features: [
  ...
  primaryCTAHref: '/',
  secondaryCTAHref: '#artisan-video',
  imageUrl:
